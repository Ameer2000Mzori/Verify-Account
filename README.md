...
> Verify-Account is a website created with HTML, SCSS, and TypeScript. We use linters to verify code errors and maintain clean code. Please check out the live demo.
...
- [Live Demo Link](https://ameer2000mzori.github.io/Verify-Account/src/)
